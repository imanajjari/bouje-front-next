...
export default function CannesRedCarpetSectionSSR({ posts, locale }) {
  ...
  return (
    <section
      className="flex flex-col items-center px-4 py-10 max-w-screen-xl mx-auto"
      dir="rtl"
      aria-label="Cannes Red Carpet Section"
    >
        ...
        <div className="order-1 md:order-none md:basis-1/2 flex flex-col items-center">
          <article className="w-full" aria-labelledby={`title-${center.id}`}>
            ...
            <div className="text-center mt-8 px-4">
              ...
              <h1
                id={`title-${center.id}`}
                className="text-4xl font-extrabold leading-tight mt-3"
              >
                <Link href={`/${locale}/magazine/${center.slug}`}>
                  {center.title}
                </Link>
